...
def main(root_path, split, keepclasses, shot):
    dirname = "BDD"
    ...
    for cls in classnames:
        with open(os.path.join("bddsplit/seed0", "box_{}shot_{}_train.txt".format(shot, cls))) as f:
    ...
    support_path = os.path.join(root_path, 'bdd_{}_{}_{}shot'.format(split, keepclasses, shot))
...
if __name__ == '__main__':
    ...
    for keepclasses in ['all',]: #'novel']:
            for shot in [5]:
                ...
                since = time.time()
                support_df = main(root_path, split, keepclasses, shot)
                support_df.to_pickle("./bdd_{}_{}_{}shot.pkl".format(split, keepclasses, shot))
