...
class BDDDetectionEvaluator(DatasetEvaluator):
    """
    Evaluate BDD AP.
    ...
    def __init__(self, dataset_name):
        """
        Args:
            dataset_name (str): name of the dataset, e.g., "bdd_test"
        """
    ...
    def evaluate(self):
        ...
        with tempfile.TemporaryDirectory(prefix="bdd_eval_") as dirname:
